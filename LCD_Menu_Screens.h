...
#define HEATER_TARGET_TEMPERATURE_HYSTERESIS    1 // Celcius 
...
// Button sizes
#define BUTTON_SETTINGS_INCREMENT_WIDTH  40
#define BUTTON_SETTINGS_INCREMENT_HEIGHT 40
#define BUTTON_SETTINGS_DECREMENT_WIDTH  40
#define BUTTON_SETTINGS_DECREMENT_HEIGHT 40
#define BUTTON_SETTINGS_KEYPAD_WIDTH     80
#define BUTTON_SETTINGS_KEYPAD_HEIGHT    40

// Button positions
#define BUTTON_SETTINGS_INCREMENT_X  40
#define BUTTON_SETTINGS_INCREMENT_Y  40
#define BUTTON_SETTINGS_DECREMENT_X  BUTTON_INCREMENT_X + (BUTTON_INCREMENT_WIDTH / 2) + SPACING_5_PIXELS
#define BUTTON_SETTINGS_DECREMENT_Y  BUTTON_INCREMENT_Y
#define BUTTON_SETTINGS_KEYPAD_X     BUTTON_DECREMENT_X + (BUTTON_DECREMENT_WIDTH / 2) + SPACING_15_PIXELS
#define BUTTON_SETTINGS_KEYPAD_Y     BUTTON_INCREMENT_Y + (BUTTON_INCREMENT_HEIGHT / 2) + SPACING_5_PIXELS

// Text positions
#define TEXT_SETTINGS_COUNTER_LIMIT_X  BUTTON_DECREMENT_X + (BUTTON_COUNTER_WIDTH/2) + SPACING_10_PIXELS
#define TEXT_SETTINGS_COUNTER_LIMIT_Y  BUTTON_DECREMENT_Y - SPACING_5_PIXELS

// Button indexes
#define BUTTONS_SETTINGS_ARRAY_INDEX_COUNTER_LIMIT 0
#define BUTTONS_SETTINGS_ARRAY_INDEX_BACK          1
#define BUTTONS_SETTINGS_ARRAY_NUM                 2

// Text indexes
#define TEXT_SETTINGS_BUTTONS_ARRAY_INDEX_TITLE    0
#define TEXT_SETTINGS_BUTTONS_ARRAY_INDEX_COUNTER  1
#define TEXT_SETTINGS_BUTTONS_ARRAY_NUM            2
